...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <div class="w3-container" id="planBoard" style="margin-top:75px; color: green; font-weight: bolder;">
        <h1 class="w3-xxxlarge w3-text-green"><b>Introduce</b></h1>
        <hr style="width:50px;border:5px solid green" class="w3-round">
        <p>• 구직중인 신입 웹 개발자입니다. 잘 부탁드립니다. (domain goddady에서 구매, cafe24에서 호스트 서버 임대 중)</p>
        <p>• 보유기술1 : JSP, Spring, MyBatis, JSTL, EL, HTMl, CSS, Javascript, DBMS(MariaDB, Oracle, MySql 다룹니다.), Git 사용가능, MVC 패턴으로
            웹
            구축</p>
    ...
    <div class="w3-row-padding">
        <h1 class="w3-xxxlarge w3-text-green"><b>Board</b></h1>
        <hr style="width:50px;border:5px solid green" class="w3-round">
    ...
    <div class="w3-container" id="funBoard" style="margin-top:75px">
        <h1 class="w3-xxxlarge w3-text-green"><b>Fun Board</b></h1>
        <hr style="width:50px;border:5px solid green" class="w3-round">
        <h2>자료실 제작 예정</h2>
    </div>
    ...
    <div class="w3-container" id="planBoard" style="margin-top:75px">
        <h1 class="w3-xxxlarge w3-text-green"><b>Plan Board</b></h1>
        <hr style="width:50px;border:5px solid green" class="w3-round">
        <h2>계획일정</h2>
    </div>
    <!-- W3.CSS Container -->
