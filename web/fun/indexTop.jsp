...
<nav class="w3-sidebar w3-green w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
    ...
    <div class="w3-container">
        <a href="../WEB-INF/views/main/index.jsp"><h3 class="w3-padding-64 w3-bar-item w3-button w3-hover-green"><b>NAMUBADA</b></h3></a>
    </div>
    <div class="w3-bar-block">
        ...
        <a href="../WEB-INF/views/main/index.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">처음으로</a>
